        ...
        if (currentUser != null) {
            if ("boss".equals(currentUser.getPosition()) || "manager".equals(currentUser.getPosition())) {
                try {
                    ...
                    MonthlySaleAmount monthlySaleAmount = monthlySaleAmountDataController.query(Integer.parseInt(request.getParameter("queryID")));

                    request.setAttribute("MonthlySaleAmountInfo", monthlySaleAmount);
