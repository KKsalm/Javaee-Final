...
public class GetSinglePurchaseRecordController extends HttpServlet  {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (currentUser != null) {
            try {
                ...
                purchaseRecord = purchaseRecordDataController.queryByID(Integer.parseInt(req.getParameter("purchaseRecordID")));
