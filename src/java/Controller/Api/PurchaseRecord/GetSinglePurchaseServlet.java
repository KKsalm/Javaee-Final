...
@WebServlet(name = "GetSinglePurchaseServlet")
public class GetSinglePurchaseServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (currentUser != null) {
            try {
                ...
                purchaseRecord = purchaseRecordDataController.queryByID(Integer.parseInt(request.getParameter("purchaseRecordID")));
