...
@WebServlet(name = "CreateMonthlySaleAmountServlet")
public class CreateMonthlySaleAmountServlet extends HttpServlet {

    private final String[] Message = {"Create Successfully", "Empty Request", "Without Permission", "SaleAmount Already Exist"};
    private final Logger logger = LogManager.getLogger(CreateMonthlySaleAmountServlet.class);
            ...
            if ("boss".equals(currentUser.getPosition())) {
                if (request.getParameter("storeID") != null) {
                    try {
                        ...
                        monthlySaleAmountDataController.createSaleAmount(Integer.parseInt(request.getParameter("storeID")));
