...
rel=stylesheet><![endif]-->
    <!--[if (!IE)|(gte IE 8.0)]><!-->
    <link href="/errorPage/files/qbase_datauri.css" type=text/css rel=stylesheet>
    <!--<![endif]-->
    <STYLE type=text/css>
        .mod-notfound {
...
<BODY>
        ...
        <DIV class="mod-page-main wordwrap clearfix">
            <DIV class=x-page-container>
                <DIV class="mod-notfound grid-98">
                    <IMG class=img-notfound height=320 src="/errorPage/files/notfound.gif" width=520>
    ...
    <FOOTER class="mod-footer mod-cs-footer">
        ...
        <DIV class=footer-box>
            ...
            <DIV class=copy-box>©2020&nbsp;whatever</DIV>
        </DIV>
    </FOOTER>
